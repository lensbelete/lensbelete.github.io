      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br />
            I am a fourth-year software engineering student at Addis Ababa University (AAIT), passionate about creating innovative solutions through code. My studies have provided me with a solid foundation in programming and development, enabling me to work on Web development projects. I constantly seek to learn new technologies and apply them in real-world scenarios.
            <br />
